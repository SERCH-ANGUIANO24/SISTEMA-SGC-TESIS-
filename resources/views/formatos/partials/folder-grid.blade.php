    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
            <div class="card folder-card h-100 border-0 shadow-sm" 
                 ...
                 onclick="window.location.href='{{ route('formatos.index', ['folder' => $folder->id]) }}'"
                ...
                <div class="card-body text-center p-3">
                    ...
                    <small class="text-muted">
                        {{ $folder->documents->count() }} formatos
                    </small>
                    ...
                    <div class="mt-3 d-flex justify-content-center gap-1" onclick="event.stopPropagation();">
                        ...
                        <form action="{{ route('formatos.folder.destroy', $folder->id) }}" method="POST" class="d-inline" id="delete-form-{{ $folder->id }}">
                            @csrf
                            @method('DELETE')
...
<style>
    ...
    {{-- ESTILOS PARA COLORES DE CARPETAS --}}
...
<script>
    ...
    function openRenameModal(folderId, folderName) {
        ...
        form.action = '{{ route("formatos.folder.rename", ["id"=> "REPLACE_ID"]) }}'.replace('REPLACE_ID', folderId);
    ...
    function openMoveModal(folderId, folderName) {
        ...
        form.action = '{{ route("formatos.folder.move", ["id" => "REPLACE_ID"]) }}'.replace('REPLACE_ID', folderId);
        ...
        fetch('{{ route("formatos.folders.tree") }}?current_folder=' + folderId)
