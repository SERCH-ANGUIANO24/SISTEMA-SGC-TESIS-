                ...
                <div class="modal-body p-0" style="height: 80vh;">
                    @if(in_array($extension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg']))
                        <div class="d-flex justify-content-center align-items-center h-100">
                            <img src="{{ asset('storage/' . $doc->file_path) }}" class="img-fluid" alt="{{ $doc->name }}" style="max-height: 100%; object-fit: contain;">
                        </div>
                    @elseif(in_array($extension, ['pdf']))
                        <iframe src="{{ route('anexos.document.view', $doc->id) }}" style="width: 100%; height: 100%; border: none;"></iframe>
