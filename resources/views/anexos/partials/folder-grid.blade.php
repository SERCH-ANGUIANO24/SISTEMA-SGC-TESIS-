...
<script>
    ...
    function openRenameModal(folderId, folderName) {
        ...
        form.action = '{{ route("anexos.folder.rename", ["id"=> "REPLACE_ID"]) }}'.replace('REPLACE_ID', folderId);
    ...
    function openMoveModal(folderId, folderName) {
        ...
        form.action = '{{ route("anexos.folder.move", ["id" => "REPLACE_ID"]) }}'.replace('REPLACE_ID', folderId);
        ...
        fetch('{{ route("anexos.folders.tree") }}?current_folder=' + folderId)
