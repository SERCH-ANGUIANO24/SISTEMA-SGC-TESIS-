        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-start">
                ...
                <div class="mt-2">
                    ...
                    {{-- BOTÓN SUBIR ARCHIVO - Solo usuarios normales y solo en subcarpetas --}}
                    @if(!in_array($userRole, ['superadmin', 'admin']) && isset($currentFolder) && $currentFolder && $currentFolder->parent_id !== null)
